...
public class DBUtility {
    private static String user = "Abhishek200520945"; // Replace with your database username
    private static String pass = "GfTEwunVRE"; // Replace with your database password
    private static String dbName = "Abhishek200520945"; // Replace with your database name
